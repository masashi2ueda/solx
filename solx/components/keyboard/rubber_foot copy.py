...
class RubberFoot(SolxObject):
    def __init__(
        ...
        screw_cylinder = Cylinder(radius=screw_r, height=100, center=CenterType.BOTTOM_CENTER)
        ...
        cube = cube.translate((0, 0, cylinder_h))

        cylinder1 = Cylinder(radius=cylinder_r1, height=cylinder_h, center=CenterType.BOTTOM_CENTER)
        cylinder2 = Cylinder(radius=cylinder_r2, height=cylinder_h, center=CenterType.BOTTOM_CENTER)
        cylinder3 = Cylinder(radius=cylinder_r3, height=cylinder_h, center=CenterType.BOTTOM_CENTER)
